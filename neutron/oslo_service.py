...
# All Rights Reserved.
#
# based on neutron.service and nova.service
...
from neutron import service as neutron_service  # noqa  # for service_opts
...
# replacement for neutron.openstack.common.rpc.service.Service
...
# replacement for neutron.service.Service
class NeutronService(RpcService):
    def __init__(self, conf, host, binary, topic, manager,
        ...
        self.timers = []
        super(NeutronService, self).__init__(conf, host, topic,
                                             manager=self.manager)

    def start(self):
        self.manager.init_host()
        super(NeutronService, self).start()
    ...
    def stop(self):
        super(NeutronService, self).stop()
    ...
    def wait(self):
        super(NeutronService, self).wait()
        for x in self.timers:
            try:
                x.wait()
            except Exception:

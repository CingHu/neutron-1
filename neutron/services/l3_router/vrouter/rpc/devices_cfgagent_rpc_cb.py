...
class DeviceCfgRpcCallback(rpc.RpcCallBack):
    """Callback for cfg agent device reporting rpc support."""
    RPC_API_VERSION = '1.1'

    def __init__(self, l3plugin):
        super(DeviceCfgRpcCallback, self).__init__()
    ...
    def sync_hosting_devices(self, context, hosting_device_ids):
        # TODO(yamahtata): revise later
        return self._l3plugin.get_hosting_devices(context, hosting_device_ids)

...
from neutron.tests.unit.services.vm.mgmt_drivers import test_rpc
from neutron.vm.mgmt_drivers.rpc import proxy
...
class TestMgmtProxyDriver(test_rpc.TestMgmtRpcDriver):
    ...
    def setUp(self):
        ...
        self.mock_proxy_api_p = mock.patch(
            'neutron.vm.proxy_api.ServiceVMPluginApi')
    ...
    def test_mgmt_create_post_delete_post(self):
        ...
        target = 'topic=%s' % topics.SERVICEVM_AGENT
        ...
        mock_instance.destroy_rpc_proxy.assert_has_calls([
            mock.call(self._PROXY_ID[1]), mock.call(self._PROXY_ID[0])])
        mock_instance.destroy_rpc_namespace_proxy.assert_has_calls([
            mock.call(self._PORT_ID, self._NS_PROXY_ID[1]),
            mock.call(self._PORT_ID, self._NS_PROXY_ID[0])])
    ...
    def test_mgmt_service_create_pre_delete_post(self):
        ...
        mgmt_driver.mgmt_service_delete_post(
            self.plugin, self._CONTEXT, self._DEVICE, self._SERVICE_INSTANCE)
        mock_instance.destroy_rpc_proxy.assert_has_calls([
            mock.call(self._PROXY_ID[3]), mock.call(self._PROXY_ID[2])])
        mock_instance.destroy_rpc_namespace_proxy.assert_has_calls([
            mock.call(self._PORT_ID, self._NS_PROXY_ID[3]),
            mock.call(self._PORT_ID, self._NS_PROXY_ID[2])])

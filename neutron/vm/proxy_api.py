...
class ServiceVMPluginApi(proxy.RpcProxy):
    API_VERSION = '1.0'
    ...
    def destroy_rpc_proxy(self, context, rpc_proxy_id):
        return self._call(context, rpc_proxy_id=rpc_proxy_id)

    def create_rpc_namespace_proxy(self, context, port_id, src_unix_target,
                                   dst_transport_url, dst_target, direction):
        """
        :param src_unix_target: target to listen/send
        :type src_unix_target: oslo.messaging.Target
